...
Invoke the `bmad-review-adversarial-general` skill on this diff. Review from `/Users/kevishie/Projects/find-the-edge-codex-login-back` and report only actionable findings with file and line references.
